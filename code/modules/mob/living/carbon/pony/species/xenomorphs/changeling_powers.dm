/proc/alien_queen_exists(var/ignore_self,var/mob/living/carbon/pony/self)
	for(var/mob/living/carbon/pony/Q in living_mob_list)
		if(self && ignore_self && self == Q)
			continue
		if(Q.species.name != "Changeling Queen")
			continue
...
/mob/living/carbon/pony/proc/gain_plasma(var/amount)
...
/mob/living/carbon/pony/proc/check_alien_ability(var/cost,var/needs_foundation,var/needs_organ)
...
// Free abilities.
/mob/living/carbon/pony/proc/transfer_plasma(mob/living/carbon/pony/M as mob in oview())
...
/mob/living/carbon/pony/proc/lay_egg()
	...
	if(!config.aliens_allowed)
		...
		verbs -= /mob/living/carbon/pony/proc/lay_egg
		return
...
/mob/living/carbon/pony/proc/corrosive_acid(O as obj|turf in oview(1)) //If they right click to corrode, an error will flash if its an invalid target./N
...
/mob/living/carbon/pony/proc/neurotoxin(mob/target as mob in oview())
...
/mob/living/carbon/pony/proc/resin() // -- TLE
