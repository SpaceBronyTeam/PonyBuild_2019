...
on which they also work. Also often a little stronger than other ponies."
	...
	на коих они же и работают. Также зачастую несколько сильнее других пони. Их главное преимущество: Сила и выносливость. \
	Благодаря им земнопони способны носить самые тяжелые доспехи без помехи к передвижению, а в ближнем бою они представляют \
...
A skilled mage can be a very dangerous opponent."
	...
	Умелый маг может быть очень опасным противником. К счастью, большинство единорогов ограничивает себя лишь изучением \
	базовых дисциплин, как свет и малый телекинез, которые, однако, очень пригождаются в быту и являются неоспоримым \
	преимуществом в профессиях где требуется тонкая моторика или бесконтактное взаимодействие."
