...
/mob/proc/hear_say(var/message, var/verb = "says", var/datum/language/language = null, var/alt_name = "",var/italics = 0, var/mob/speaker = null, var/sound/speech_sound, var/sound_vol)
	...
	if(client.censure && speaker.species in list("Earthpony", "Unicorn", "Pegasus"))
		message = pony_censure(message)
...
/mob/proc/hear_radio(var/message, var/verb="says", var/datum/language/language=null, var/part_a, var/part_b, var/mob/speaker = null, var/hard_to_hear = 0, var/vname ="")
	...
	if(istype(src, /mob/living/silicon/ai) && !hard_to_hear)
		...
		var/mob/living/carbon/pony/impersonating //The crew member being impersonated, if any.
		...
		if (ispony(speaker))
			...
			if(H.wear_mask && istype(H.wear_mask,/obj/item/clothing/mask/gas/voice))
				...
				var/mob/living/carbon/pony/I = impersonated[speaker_name]
		...
		else if (iscarbon(speaker)) // Nonpony carbon mob
			jobname = "No id"
