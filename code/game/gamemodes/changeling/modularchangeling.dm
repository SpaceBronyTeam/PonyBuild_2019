...
/datum/power/changeling/absorb_dna
	name = "Absorb DNA"
	desc = "Permits us to syphon the DNA from a pony. They become one with us, and we become stronger."
	genomecost = 0
...
/datum/power/changeling/make_transform_cocoon
	name = "Transform"
	desc = "We take on the apperance and voice of one we have absorbed."
	genomecost = 0
	verbpath = /mob/proc/changeling_make_transform_cocoon
...
/datum/power/changeling/deaf_sting
	name = "Deaf Sting"
	desc = "We silently sting a pony, completely deafening them for a short time."
	genomecost = 1
	allowduringlesserform = 1
...
/datum/power/changeling/blind_sting
	name = "Blind Sting"
	desc = "We silently sting a pony, completely blinding them for a short time."
	genomecost = 2
	allowduringlesserform = 1
...
/datum/power/changeling/silence_sting
	name = "Silence Sting"
	desc = "We silently sting a pony, completely silencing them for a short time."
...
/datum/power/changeling/transformation_sting
	...
	desc = "We silently sting a pony, injecting a retrovirus that forces them to transform into another."
...
/datum/power/changeling/paralysis_sting
	...
	desc = "We silently sting a pony, paralyzing them for a short time."
	genomecost = 8
...
/datum/power/changeling/DeathSting
	name = "Death Sting"
	desc = "We silently sting a pony, filling him with potent chemicals. His rapid death is all but assured."
	genomecost = 10
	verbpath = /mob/proc/changeling_DEATHsting

///datum/power/changeling/unfat_sting
//	name = "Unfat Sting"
//	desc = "We silently sting a pony, forcing them to rapidly metabolize their fat."
//	genomecost = 1
//	verbpath = /mob/proc/changeling_unfat_sting

/datum/power/changeling/boost_range
	name = "Boost Range"
	desc = "We evolve the ability to shoot our stingers at ponys, with some preperation."
	genomecost = 2
	allowduringlesserform = 1
...
/datum/power/changeling/DigitalCamoflague
	...
	helptext = "We cannot be tracked by camera while using this skill.  However, ponys looking at us will find us.. uncanny.  We must constantly expend chemicals to maintain our form like this."
	genomecost = 1
	allowduringlesserform = 1
